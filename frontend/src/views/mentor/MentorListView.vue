<template>
    <div class="bg-gray-100 min-h-screen p-8 font-sans">   
      ...
      <MentorFormModal v-if="showMentorForm" :mentor="selectedMentor" @close="closeMentorForm" @saved="fetchMentors" />
...
const filteredMentors = computed(() => {
  ...
  if (searchTeam.value) {
    result = result.filter(m => m.team && m.team.toLowerCase().includes(searchTeam.value.toLowerCase()))
  }
