...
public interface EvaluationCriteriaMapper {
    ...
    default List<EvaluationCriteriaResponse> toResponseListWithoutChildren(Set<EvaluationCriteria> criteriaList) {
        if (criteriaList == null) return null;
        return criteriaList.stream()
                .filter(EvaluationCriteria::getIsActive)
                .sorted(Comparator.comparing(EvaluationCriteria::getDisplayOrder))
    ...
    default List<CriteriaScoreDefinitionResponse> toScoreDefinitionResponseList(Set<CriteriaScoreDefinition> definitions) {
        ...
        return definitions.stream()
                .sorted(Comparator.comparing(CriteriaScoreDefinition::getId))
