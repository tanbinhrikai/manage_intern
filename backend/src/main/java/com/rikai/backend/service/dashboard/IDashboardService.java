...
public interface IDashboardService {
    ...
    MentorStatisticsResponse getMentorStatistics();

    ChartDataResponse getMentorAverageScoreTrend(int months);

    ChartDataResponse getMentorInternStatusDistribution();
}
