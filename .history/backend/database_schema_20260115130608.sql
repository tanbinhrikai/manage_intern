-- =====================================================
-- RIKAI INTERN MANAGEMENT SYSTEM - DATABASE SCHEMA
-- MySQL Script
-- =====================================================

-- Drop database if exists (for fresh start)
-- DROP DATABASE IF EXISTS rikai_db;
-- CREATE DATABASE rikai_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE rikai_db;
...
-- Note: id uses CHAR(36) to store UUID as string format
-- =====================================================
...
CREATE TABLE IF NOT EXISTS evaluation_criteria (
    ...
    CONSTRAINT chk_criteria_category CHECK (category IN ('CHUYEN_MON', 'TU_DUY', 'KY_NANG'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
